...
def get_vite_diff():
    # Read the intended JS config but use it as the source for TS diff
    with open('vite.config.js', 'r', encoding='utf-8') as f:
        my_config = f.read()
    
    # Baseline for react-vite (TS)
...
if __name__ == "__main__":
    ...
    # Add my vite.config content via diff to the baseline file
    ...
    print("Manifest created with {} files.".format(len(files)))
