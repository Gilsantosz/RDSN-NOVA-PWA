        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-white dark:bg-slate-900/40 backdrop-blur-3xl p-5 sm:p-6 shadow-2xl border border-slate-200 dark:border-white/5 mb-6">
          ...
          <div className="relative flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8">
            <div className="flex items-center gap-4 sm:gap-5">
              <div className="w-16 h-16 sm:w-14 sm:h-14 bg-gradient-to-br from-emerald-600 to-teal-500 rounded-[2rem] flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all hover:scale-105 active:scale-95 group border border-emerald-400/20">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
              ...
              <div className="flex items-center justify-between p-5 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm">
                <div className="space-y-0.5">
                  ...
                  <p className="text-[9px] font-bold text-slate-500 uppercase tracking-wider">
                    {formData.ordem_numeracao === 'DECRESCENTE'
                      ? 'Emissão do maior para o menor número (↓ REVERSA)'
                      : 'Emissão do menor para o maior número (↑ SEQUENCIAL)'}
                  </p>
                </div>
                <Select
                ...
                >
                  ...
                  <SelectContent className="rounded-xl border-white/10 backdrop-blur-xl">
                    <SelectItem value="CRESCENTE" className="font-bold text-xs uppercase">↑ SEQUENCIAL</SelectItem>
                    <SelectItem value="DECRESCENTE" className="font-bold text-xs uppercase">↓ REVERSA</SelectItem>
                  </SelectContent>
                </Select>
              </div>
