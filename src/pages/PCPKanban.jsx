...
export default function PCPKanban() {
    ...
    const handleAddProduct = () => {
        const total = parseInt(newProduct.totalQty);
    ...
    return (
        <div className="kanban-page h-full min-h-screen bg-transparent p-4 transition-all">
            ...
            {/* Header Premium */}
            <div className="relative overflow-hidden rounded-[2.5rem] bg-white dark:bg-slate-900/40 backdrop-blur-3xl p-8 sm:p-10 shadow-2xl border border-slate-200 dark:border-white/5 mb-8">
                ...
                <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div className="flex items-center gap-6 sm:gap-8">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-600 to-indigo-500 rounded-[2rem] flex items-center justify-center shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all hover:scale-105 active:scale-95 group border border-blue-400/20">
                            <LayoutDashboard className="w-8 h-8 sm:w-10 sm:h-10 text-white group-hover:rotate-6 transition-transform duration-500" />
                        </div>
